...
const FIELD_MAPS = {
  ...
  BubbleLeave: {
    ...
    "info_tech": "info_tech_url",
    "info-tech": "info_tech_url",
    "info_tech_file": "info_tech_url",
    "info-tech_file": "info_tech_url",
    ...
    "reject reason_text": "reject_reason",
  ...
  BubbleClockin: {
    ...
    "tags___in_list_text": "tags_in",
    "tag_list_text": "tags_in",
    "tags_list_text": "tags_in",
    "Tags - out": "tags_out",
    "Tags - Out": "tags_out",
    "Tag - Out": "tags_out",
    "tag___out_list_text": "tags_out",
    "tags___out_list_text": "tags_out",
  },
  BubbleManHourDate: {
  ...
  BubbleLeaveQuota: {
    "+/- Quota": "plus_minus_quota",
    "Calculation Date": "calculation_date",
    "Count Year": "count_year",
    "Operator (text)": "operator_text",
    "Reason": "reason",
    "Staff": "staff_id",
